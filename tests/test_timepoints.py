...
#         jobs=-1,
#     )
#     directory = f"timepoints_level/tmp_{data2.shape[0]}/"
...
lines2 = plt.plot(range(len(data2)), dataset.iloc[:tmp, 1], "b", linewidth=2)
lines3 = plt.plot(range(len(data2)), dataset.iloc[:tmp, 2], "g", linewidth=2)
lines4 = plt.plot(range(len(data2)), dataset.iloc[:tmp, 3], "c", linewidth=2)
